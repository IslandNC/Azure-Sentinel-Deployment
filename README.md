...
> > |---|---|---|---|
> > | [impossible-travel-detection.kql](queries/identity/impossible-travel-detection.kql) | Sign-ins from different countries | 24h | T1078 — Valid Accounts |
> > | [brute-force-signin-1h.kql](queries/identity/brute-force-signin-1h.kql) | Failed logins ≥5 per IP (hunting) | 1h | T1110.001 — Brute Force |
> > | [brute-force-signin-5m.kql](queries/identity/brute-force-signin-5m.kql) | Failed logins ≥5 per IP (real-time alerting) | 5m | T1110.001 — Brute Force |
> >
> > ### Endpoint Queries
> >
> > | Query File | Purpose | Lookback | MITRE |
> > |---|---|---|---|
> > | [process-creation-anomaly.kql](queries/endpoint/process-creation-anomaly.kql) | LOLBin and suspicious process execution | 1h | T1059, T1218 |
> >
...
> > >
> > > | Rule | Severity | Status | KQL Used |
> > > |---|---|---|---|
> > > | Entra ID – User Sign-in from Different Location | High | Enabled | [impossible-travel-detection.kql](queries/identity/impossible-travel-detection.kql) |
> > > | RDP Brute Force Attack | Medium | Enabled | [brute-force-signin-1h.kql](queries/identity/brute-force-signin-1h.kql) (hunting) / [brute-force-signin-5m.kql](queries/identity/brute-force-signin-5m.kql) (rule) |
> > > | SSH Brute Force on Linux | Low | Enabled | [brute-force-signin-5m.kql](queries/identity/brute-force-signin-5m.kql) |
> > >
> > > See [04-detection-rules.md](docs/04-detection-rules.md) for full MITRE mapping, scheduling, and triage procedures.
> > >
> > > ---
> > >
