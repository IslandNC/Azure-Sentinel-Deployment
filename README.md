...
| RDP Brute Force Attack | Medium | Enabled | [brute-force-signin-5m.kql](queries/identity/brute-force-signin-5m.kql) (rule) / [brute-force-signin-1h.kql](queries/identity/brute-force-signin-1h.kql) (hunting) |
